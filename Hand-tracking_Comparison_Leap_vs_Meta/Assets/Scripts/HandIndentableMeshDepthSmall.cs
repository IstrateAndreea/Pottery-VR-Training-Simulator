...
public class HandIndentableMeshDepthSmall : MonoBehaviour
{
    public float indentRadius = 0.03f;
    public float maxIndentStrength = 0.12f; // Deep indent
    ...
    private Dictionary<XRHandJointID, bool> latencyCaptured = new();
